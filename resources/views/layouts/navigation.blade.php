<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center gap-2">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        ...
                        <span class="hidden md:inline font-bold text-gray-800 tracking-tight">Portal UMKM</span>
                    </a>
                    <span class="px-2 py-0.5 text-xs font-bold rounded-full {{ auth()->user()->role === 'admin' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800' }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->role === 'admin')
                        <x-nav-link :href="route('admin.umkm-profiles.pending')" :active="request()->routeIs('admin.umkm-profiles.pending')">
                            Persetujuan
                        </x-nav-link>
                        <x-nav-link :href="route('admin.umkm-profiles.index')" :active="request()->routeIs('admin.umkm-profiles.index')">
                            Semua UMKM
                        </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('katalog.publik')">
                            🌐 Lihat Situs Publik
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->role === 'admin')
                <x-responsive-nav-link :href="route('admin.umkm-profiles.pending')" :active="request()->routeIs('admin.umkm-profiles.pending')">
                    Persetujuan
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.umkm-profiles.index')" :active="request()->routeIs('admin.umkm-profiles.index')">
                    Semua UMKM
                </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('katalog.publik')">
                    🌐 Lihat Situs Publik
                </x-responsive-nav-link>
